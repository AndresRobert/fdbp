                                    ...
                                    },
                                    {
                                        "mRender": function (d, t, row) {
                                            let btnEdit = '<a href="#!" onclick="contractEdit(' + row.id + ')" data-tooltip="Editar" class="tooltipped btn-flat"><i class="material-icons">edit</i></a>',
                                                ...
                                                btnPublish = '<a href="#!" onclick="contractPublish(' + row.warning + ')" data-tooltip="Publicar en Facebook" class="tooltipped btn-flat"><i class="material-icons">record_voice_over</i></a>';
                                            if (row.invoice === '') {
