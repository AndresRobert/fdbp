                        ...
                        Helper.Datatable.init(
                            "#contracts_list",
                            {
                                ...
                                "columns" : [
                                    ...
                                    {
                                        "mRender": function (d, t, row) {
                                            return '<a href="#!" onclick="contractView(' + row.id + ')" class="btn-flat waves-effect waves-googleBlue"><i data-tooltip="Ver" class="tooltipped material-icons">remove_red_eye</i></a>' +
                                                '<a href="#!" onclick="contractEdit(' + row.id + ')" class="btn-flat waves-effect waves-googleYellow"><i data-tooltip="Editar" class="tooltipped material-icons">edit</i></a>' +
                                                '<a href="#!" onclick="contractDelete(' + row.id + ')" class="btn-flat waves-effect waves-googleRed"><i data-tooltip="Eliminar" class="tooltipped material-icons">delete_forever</i></a>' +
                                                '<a href="#!" onclick="contractSend(' + row.id + ')" class="btn-flat waves-effect waves-googleGreen"><i data-tooltip="Enviar" class="tooltipped material-icons">mail</i></a>' +
                                                '<a href="#!" onclick="contractPublish(' + row.id + ')" class="btn-flat waves-effect waves-googleGreen"><i data-tooltip="Publicar" class="tooltipped material-icons">record_voice_over</i></a>';
                                        }
                                    }
                                ]
                            }
